...
@section('title', 'Invis - Create Suplliers')

@section('content')

    <div class="mx-auto max-w-lg">
        <h1 class="font-bold mb-2">Create</h1>
        <form class="w-full max-w-lg" method="POST" action="{{ url('suppliers') }}">
            @csrf
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <input
                        ...
                        type="text" id="supplier_name" name="supplier_name" placeholder="Budi">
                </div>
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <input
                        class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        type="text" id="supplier_phone" name="supplier_phone" placeholder="081234567890">
                </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    ...
                    <input
                        ...
                        type="text" id="supplier_address" name="supplier_address" placeholder="Jl.merdeka 123">
                </div>
            </div>
            <button type="submit"
